...
export default function Shop(){
    return (
        ...
        <h1 className="text-customBlue text-center lg:py-6 xl:text-left lg:text-3xl font-bold text-xl sm:text-2xl pb-3 lg:pb-10">
          Buy What you Like
        </h1>
        {/* 1st row */}
        <div>
        ...
        {/* 3rd row */}
        <div>
          <div className="grid grid-rows-1 px-10 sm:px-16 md:px-28 lg:px-0 lg:grid-cols-4 lg:mt-20 gap-4">
            {/* card 1 */}
            <div className="relative inline-block">
              <div className="absolute top-2 left-2">
                <p className="text-white px-4 py-1 rounded-md bg-green-600">
